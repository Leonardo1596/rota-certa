              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {formatCurrency(settings.oleo.lifespanKm > 0 ? (settings.oleo.price / settings.oleo.lifespanKm) * metrics.totalDistance : 0)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Relação:</p>
                  <p className="text-sm text-muted-foreground">
                    {formatCurrency(settings.relacao.lifespanKm > 0 ? (settings.relacao.price / settings.relacao.lifespanKm) * metrics.totalDistance : 0)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Pneu Dianteiro:</p>
                  <p className="text-sm text-muted-foreground">
                    {formatCurrency(settings.pneuDianteiro.lifespanKm > 0 ? (settings.pneuDianteiro.price / settings.pneuDianteiro.lifespanKm) * metrics.totalDistance : 0)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Pneu Traseiro:</p>
                  <p className="text-sm text-muted-foreground">
                    {formatCurrency(settings.pneuTraseiro.lifespanKm > 0 ? (settings.pneuTraseiro.price / settings.pneuTraseiro.lifespanKm) * metrics.totalDistance : 0)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Gasolina:</p>
                  <p className="text-sm text-muted-foreground">
                    {formatCurrency(settings.kmPerLiter > 0 ? (settings.gasolinaPricePerLiter / settings.kmPerLiter) * metrics.totalDistance : 0)}
                  </p>
                </div>
              </div>
            </CardContent>
